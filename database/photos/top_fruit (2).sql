...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 20, 2025 at 08:12 PM
...
INSERT INTO `ingredients` (`id`, `name`, `unit`, `current_stock`, `reorder_level`, `price`, `supplier_id`) VALUES
(4, 'kjkl', 'piece', 111, 1111, 11, 3);
...
CREATE TABLE `orders` (
  ...
  `dicount_id` int(11) DEFAULT NULL,
...
CREATE TABLE `order_items` (
  ...
  `current_unit_price` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `promotions` (
  ...
  `valid_from` time DEFAULT current_timestamp(),
...
INSERT INTO `promotions` (`id`, `code`, `discount_type`, `discount_value`, `valid_from`, `valid_to`) VALUES
(1, 'LTTHEVKITD', 'percentage', 7, '00:20:25', '00:00:00'),
(2, 'QLXKZORHPM', 'percentage', 8, '00:20:25', '00:20:25');
...
CREATE TABLE `staff` (
  ...
  `role` enum('admin','barista','inventory_manager') DEFAULT 'barista',
  `tele` varchar(15) NOT NULL,
  `salary_rate` int(11) DEFAULT 20
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `staff` (`id`, `username`, `password`, `name`, `email`, `role`, `tele`, `salary_rate`) VALUES
(1, 'mostafa', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'dsfa', 'peyeni1775@prorsd.com', 'admin', '021315', 23),
(7, 'adfsf', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'asdfa', 'asdfa@gmail.com', 'barista', '1234', 12),
(8, 'sdfdfd', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'ssss', 'asdfa@gmail.com', 'barista', '1234', 20);
...
INSERT INTO `suppliers` (`id`, `name`, `email`, `telephone`) VALUES
(2, 'asfa', 'asdfa@gmail.com', '1234'),
(3, 'fghf', 'gasda@mgila.com', '12345');
...
CREATE TABLE `waste_log` (
  ...
  `staff_id` int(11) NOT NULL,
  `quantity` int(11) NOT NULL,
  `reason` enum('spolid','error','test') DEFAULT NULL,
...
--
ALTER TABLE `item_ingredient`
  ADD CONSTRAINT `item_ingredient_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `items` (`id`),
  ADD CONSTRAINT `item_ingredient_ibfk_2` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredients` (`id`);

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`dicount_id`) REFERENCES `promotions` (`id`);
...
--
ALTER TABLE `shifts`
  ADD CONSTRAINT `shifts_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`id`);

--
-- Constraints for table `waste_log`
--
ALTER TABLE `waste_log`
  ADD CONSTRAINT `waste_log_ibfk_1` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredients` (`id`),
  ADD CONSTRAINT `waste_log_ibfk_2` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`id`);
COMMIT;
