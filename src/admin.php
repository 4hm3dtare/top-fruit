...
<body>
    <div class="sidenav">
        ...
        <a href="admin.php" class="active"><i class="fas fa-list"></i> Items</a>
    ...
    <div class="main-content">
        <div class="admin-header">
            <h1 class="admin-title">Items</h1>
            <div class="header-buttons">
                <button class="new-btn" onclick="location.href='new_item.php'">New</button>
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="table-row">
                        ...
                        <div>
                            ...
                            <a href="delete_item.php?id=' . $row['id'] . '" class="delete-btn" onclick="return confirm(\'Are you sure you want to delete this item?\')">DELETE</a>
                        </div>
                    </div>';
                }
            }
