    ...
    <div class="main-content">
        <div class="admin-header">
            ...
            <div class="header-buttons">
                <button class="new-btn" onclick="location.href='new_category.php'">New</button>
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="table-row">
                        ...
                        <div>
                            ...
                            <a href="delete_categroy.php?id=' . $row['id'] . '" class="delete-btn" onclick="return confirm(\'Are you sure you want to delete this category?\')">DELETE</a>
                        </div>
                    </div>';
                }
            }
