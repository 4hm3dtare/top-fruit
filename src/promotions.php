...
$sql = "SELECT id, code, valid_to FROM promotions ORDER BY id";
...
<body>
    <div class="sidenav">
        ...
        <a href="promotions.php" class="active"><i class="fas fa-percent"></i> Promotions</a>
        <a href="ingredients.php"><i class="fas fa-ice-cream"></i> Ingredients</a>
        <a href="wastlog.php"><i class="fas fa-percent"></i> Wastage Logs</a>
    ...
    <div class="main-content">
        <div class="admin-header">
            ...
            <div class="header-buttons">
                <button class="new-btn" onclick="location.href='new_promotion.php'">New</button>
            ...
            if (mysqli_num_rows($result) > 0) {
                while($row = mysqli_fetch_assoc($result)) {
                    echo '<div class="table-row">
                        <div>' . $row['id'] . '</div>
                        <div>' . $row['code'] . '</div>
                        <div>' . $row['valid_to'] . '</div>
                        <div>
                            <a href="edit_promotion.php?id=' . $row['id'] . '" class="edit-btn">EDIT</a>
                            <a href="delete_promotion.php?id=' . $row['id'] . '" class="delete-btn" onclick="return confirm(\'Are you sure you want to delete this code?\')">DELETE</a>
                        </div>
                    </div>';
                }
            }
